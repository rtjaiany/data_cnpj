...
The primary objective of this project is to construct a robust, establishment-level longitudinal panel from the raw RFB corporate registration files to support quantitative econometric research. 
